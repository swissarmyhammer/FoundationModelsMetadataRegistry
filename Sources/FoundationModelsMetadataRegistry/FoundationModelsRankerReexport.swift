...
// embedding seam (`TextEmbedding`), and the whole selection tier
// (`SelectionTier`, `SelectionConfig`, `SelectionSessionSource`,
// `SelectionCatalog`, `SelectionMatch`, `Selection`, `RankDiagnostic`,
// `AgentSession`, and the selection-unavailable error) remain visible
