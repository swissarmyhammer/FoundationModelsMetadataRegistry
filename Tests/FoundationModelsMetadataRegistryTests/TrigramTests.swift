...
/// Tokenizer and character-trigram Sørensen-Dice tests, adapted from
/// CodeContextKit's `RankerTests.swift` "Tokenizer" and "Trigram Dice"
/// sections (which port the Rust `swissarmyhammer-search` crate's
/// `tokenize.rs`/`score.rs` test suites; see plan.md "Search"). `Trigram`
